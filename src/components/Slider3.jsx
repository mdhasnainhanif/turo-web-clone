              ...
              >
                <SwiperSlide>
                    <div className="card box_shadow py-2">
                        <img width='80%' className="mx-auto slide3img" src={hover1 ? card1color : card1} alt="" onMouseEnter={()=>setHover1(true)} onMouseLeave={()=>setHover1(false)} />
                        <h6 className="fw-bold mt-3">Los Angeles</h6> 
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className="card box_shadow py-2">
                        <img width='80%' className="mx-auto slide3img" src={hover2 ? card2color : card2} alt="" onMouseEnter={()=>setHover2(true)} onMouseLeave={()=>setHover2(false)} />
                        <h6 className="fw-bold mt-3">Miami</h6>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className="card box_shadow py-2">
                        <img width='80%' className="mx-auto slide3img" src={hover3 ? card3color : card3} onMouseEnter={()=>setHover3(true)} onMouseLeave={()=>setHover3(false)} alt="" />
                        <h6 className="fw-bold mt-3">Honolulu</h6>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className="card box_shadow py-2">
                        <img width='80%' className="mx-auto slide3img" src={hover4 ? card4color : card4} onMouseEnter={()=>setHover4(true)} onMouseLeave={()=>setHover4(false)} alt="" />
                        <h6 className="fw-bold mt-3">Denver</h6>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className="card box_shadow py-2">
                        <img width='80%' className="mx-auto slide3img" src={hover5 ? card5color : card5} onMouseEnter={()=>setHover5(true)} onMouseLeave={()=>setHover5(false)} alt="" />
                        <h6 className="fw-bold mt-3">London</h6>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className="card box_shadow py-2">
                        <img width='80%' className="mx-auto slide3img" src={hover6 ? card6color : card6} onMouseEnter={()=>setHover6(true)} onMouseLeave={()=>setHover6(false)} alt="" />
                        <h6 className="fw-bold mt-3">Toronto</h6>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className="card box_shadow py-2">
                        <img width='80%' className="mx-auto slide3img" src={hover7 ? card7color : card7} onMouseEnter={()=>setHover7(true)} onMouseLeave={()=>setHover7(false)} alt="" />
                        <h6 className="fw-bold mt-3">Jersey City</h6>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className="card box_shadow py-2">
                        <img width='80%' className="mx-auto slide3img" src={hover8 ? card8color : card8} onMouseEnter={()=>setHover8(true)} onMouseLeave={()=>setHover8(false)} alt="" />
                        <h6 className="fw-bold mt-3">San Francisco</h6>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className="card box_shadow py-2">
                        <img width='80%' className="mx-auto slide3img" src={hover9 ? card9color : card9} onMouseEnter={()=>setHover9(true)} onMouseLeave={()=>setHover9(false)} alt="" />
                        <h6 className="fw-bold mt-3">Atlanta</h6>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className="card box_shadow py-2">
                        <img width='80%' className="mx-auto slide3img" src={hover10 ? card10color : card10} onMouseEnter={()=>setHover10(true)} onMouseLeave={()=>setHover10(false)} alt="" />
